...
{
	if (cmdline[0] == 'm' && cmdline[1] == 'e' && cmdline[2] == 'm' && cmdline[3] == 0 && cons->sht != 0) {
		cmd_mem(cons, memtotal);
	} else if (cmdline[0] == 'c' && cmdline[1] == 'l' && cmdline[2] == 's' && cmdline[3] == 0 && cons->sht != 0) {
		cmd_cls(cons);
	} else if (cmdline[0] == 'd' && cmdline[1] == 'i' && cmdline[2] == 'r' && cmdline[3] == 0 && cons->sht != 0) {
		cmd_dir(cons);
	} else if (cmdline[0] == 'e' && cmdline[1] == 'x' && cmdline[2] == 'i' && cmdline[3] == 't' && cmdline[4] == 0) {
		cmd_exit(cons, fat);
	} else if (cmdline[0] == 's' && cmdline[1] == 't' && cmdline[2] == 'a' && cmdline[3] == 'r' && cmdline[4] == 't' && cmdline[5] == ' ') {
		cmd_start(cons, cmdline, memtotal);
	} else if (cmdline[0] == 'n' && cmdline[1] == 'c' && cmdline[2] == 's' && cmdline[3] == 't' && cmdline[4] == ' ') {
		cmd_ncst(cons, cmdline, memtotal);
	}  else if (cmdline[0] == 'l' && cmdline[1] == 'a' && cmdline[2] == 'n' && cmdline[3] == 'g' && cmdline[4] == 'm'
							&& cmdline[5] == 'o' && cmdline[6] == 'd' && cmdline[7] == 'e' && cmdline[8] == ' ') {
...
int cmd_app(struct CONSOLE *cons, int *fat, char *cmdline)
{
	...
	if (finfo != 0) {
		...
		if (finfo->size >= 36 && p[4] == 'H' && p[5] == 'a' && p[6] == 'r' && p[7] == 'i' && *p == 0x00) {
			segsiz = *((int *) (p + 0x0000));
			esp    = *((int *) (p + 0x000c));
			datsiz = *((int *) (p + 0x0010));
			dathrb = *((int *) (p + 0x0014));
